...
public class horoscope {
    public static void main(String[] args) {
        int day;        // def day
        String month;   // def month

        System.out.println("Burç hesaplayan programa hoşgeldiniz!");  // introduce the program to user
        Scanner myInput = new Scanner(System.in);

        System.out.print("Hangi ayda doğdunuz: ");  // get month input
        month = myInput.nextLine();
        System.out.print(month + " ayının kaçıncı günü doğdunuz: ");  // get day input
        day = myInput.nextInt();

        if (day >= 1 && day <= 31) {     // valid day interval for months
